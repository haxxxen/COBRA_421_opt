...
CFLAGS = -ffunction-sections -fdata-sections -Os -m64 -fno-builtin -fno-exceptions \
			   ...
			   -DLV2 -DDEX_KERNEL -DFIRMWARE_4_21 -DCFW -DUSE_LV1_PEEK_POKE -DPS3MAPI -DBC -DSC40 -ffreestanding 
CFLAGS += --std=gnu99
...
clean:
	rm -f *.elf *.bin *.dex *.dexr stage2/*.o stage2/*.elf stage2/*.bin stage2/*.dex stage2/*.dexr stage2/*.map *.map *.lzma lv2/src/*.o lv1/src/*.o debug/src/*.o
