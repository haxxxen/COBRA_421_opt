...
static void ps2net_copy_test(uint64_t arg0)
{
	...
	DPRINTF("COBRA :::: ++++ copy finished (%ld) (%ld KB)\n", total, total / 1024);
...
{	
	DPRINTF("COBRA :::: Modules info will be dumped in 71 seconds.\n");
