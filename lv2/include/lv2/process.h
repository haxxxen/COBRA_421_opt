...
// #define GAME_PROCESS_NAME	"_main_EBOOT.BIN"
...
/* static INLINE int is_game_process(process_t process)
{
	return (process && strcmp(get_process_name(process)+8, GAME_PROCESS_NAME) == 0);
} */
