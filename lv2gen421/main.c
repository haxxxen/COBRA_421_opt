...
static void command4(char *cmd, char *arg1, char *arg2, char *arg3, char *arg4)
{
	char buf[2048];
	
	snprintf(buf, sizeof(buf), "%s %s %s %s %s", cmd, arg1, arg2, arg3, arg4);
	system(buf);
}
...
static void command17(char *cmd, char *arg1, char *arg2, char *arg3, char *arg4, char *arg5, char *arg6, char *arg7, char *arg8, char *arg9, char *arg10, char *arg11, char *arg12, char *arg13, char *arg14, char *arg15, char *arg16, char *arg17)
{
	char buf[2048];
	
	snprintf(buf, sizeof(buf), "%s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s %s", cmd, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13,arg14, arg15, arg16, arg17);
	system(buf);
}
...
int main(int argc, char *argv[])
{
	...
	command4("F:/BKP/Tools/scetool", "-p F:/BKP/Tools/data", "--decrypt", self_input, "temp.elf");	
	patch_elf("temp.elf", stage0, payload, payload_addr, stage0_addr);	
	command17("F:/BKP/Tools/scetool", "-v", "-p F:/BKP/Tools/data", "--sce-type=SELF", "--compress-data=TRUE", "--compress-data=TRUE", "--skip-sections=FALSE", "--self-auth-id=1050000003000001", "--self-add-shdrs=TRUE", "--self-vendor-id=05000002", "--self-type=LV2", 
	         "--self-fw-version=0004002100000000", "--key-revision=0", "--self-app-version=0004002100000000", "-z 9", "--encrypt", "temp.elf", self_output);
